...
def home(request):
    ...
    room_messages = Message.object.filter(Q(room__topic__name__icontains=q))
    
    context = {'rooms': rooms, 'topic': topics, 'rooms_count': room_count, 'room_message': room_messages}
